 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(19, 180, 151, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(19, 180, 151, 0.5)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(19, 180, 151, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(19, 180, 151, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(19, 180, 151, 0.5)',
							tension:0.5,
						}
					]
				},
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(19, 180, 151, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(19, 180, 151, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(60, 101, 245, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(60, 101, 245, 1)");
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(208, 116, 7, 0.2)");
			areaChart_2gradientStroke.addColorStop(1, "rgba(208, 116, 7, 0)");
				...
				data: {
					...
					datasets: [
						...
						}, 
						{
							...
							borderColor: 'rgb(60, 101, 245)',
							borderWidth: "1",
							backgroundColor: 'rgba(60, 101, 245, .5)',
							tension: 0.5,
							fill:true,
						}
					]
